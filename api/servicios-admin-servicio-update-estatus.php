...
$result = $conn->query("select UUID from servicios where UUID='".$IdUsr."';");
$outp = "";
...
if($IdUsr==$outp){
	...
	$result = $conn->query("UPDATE servicios SET ESTATUS=".$newestatus."  WHERE UUID='".$IdUsr."' AND ESTATUS=".$edo.";");	
