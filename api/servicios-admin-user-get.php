...
$queryConcat="SELECT iD_USUARIO,NOMBRE_USUARIO,DATE_FORMAT(FECHA_CREACION_ALTA,'%Y-%m-%d') AS FCREATE, DATE_FORMAT(FECHA_MODIFICACION,'%Y-%m-%d') AS FUPDATE, ESTATUS FROM USUARIO WHERE 1=1 ";
