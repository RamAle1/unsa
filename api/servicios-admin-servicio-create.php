...
$result = $conn->query("SELECT NOMBRE FROM SERVICIOS WHERE NOMBRE='".$nombre."';");
$outp = "";
...
if($nombre!=$outp){
	...
	$result = $conn->query("insert into servicios values('".uuid()."','1920','".$nombre."','".$desc."',".$costo.",'".$hoy."','".$hoy."',".$estatus.");");
