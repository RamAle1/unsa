...
app.service('loginService', ['url', '$http', '$q', function (url, $http, $q) {
	...
	return {
		...
		createMerge: function (aid ,aclave,acarrera,anombre,sclave, snombre, scosto) {
			console.info(url.contexto + 'servicios-admin-merge.php?aid='+aid+'&&aclave=' + aclave + '&&acarrera=' + acarrera + '&&anombre=' + anombre + '&&sclave='+sclave+'&&snombre=' + snombre+ '&&scosto=' + scosto);
